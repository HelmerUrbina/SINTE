...
public interface GrifoDAO extends JpaRepository<BeanGrifo, String> {
    ...
    @Query(nativeQuery = true, value = "SELECT "
            ...
            + "VGRIFO_NOMBRE, UTIL.FUN_ESTADO_DESCRIPCION(CESTADO_CODIGO) CESTADO_CODIGO, "
    ...
    @Query(nativeQuery = true, value = "SELECT "
            + "NGRIFO_CODIGO, NBRIGADA_CODIGO, "
            + "'' VBRIGADA_DESCRIPCION, VGRIFO_NOMBRE, CESTADO_CODIGO, "
    ...
    @Transactional
    @Modifying
    @Query(value = "{CALL SP_IDU_GRIFO(:codigo, :brigada, :grifoNombre, :ubigeo, :usuario, :modo)}", nativeQuery = true)
    void sp_grifo(
